...
")
    ...
    if first_choice in ('b','B'):
        ...
        typewriter('You attack the monster but are thrown back by him.\n\
')
...
""")
            ...
            typewriter(f"Wrong answer. your weapon won't level up this round. Your weapon is level {weaponlevel} and you have {coins} coins. To deafeat the monster your weapon has to be level 6.\n\
")
...
')
            ...
            if acsend != 'yes':
                acsend2=input("You have to acsend your weapon to win the game. Are you sure you don't want to acsend it? (yes / no) ")
                if acsend2 == 'yes':
                    typewriter("You didn't acsend your weapon. You can't defeat the monster and die. ")
                    return
            if acsend == 'yes' or acsend2 == 'no':
