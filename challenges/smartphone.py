...
if (asusgoedkoop or asusgoedkoop1) < int(100) and (diff <= 50):
    print(f'Het advies is om de iphone te kopen. Deze is namelijk maar {diff} euro duurder dan de samsung en {diff1} euro duurder dan de asus.')
if (asusgoedkoop or asusgoedkoop1) < int(100) and (diff > 50) :
